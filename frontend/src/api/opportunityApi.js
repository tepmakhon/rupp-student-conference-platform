...
export const applyOpportunity = async (id, payload) => {
...
export const getSavedOpportunities = async () => {
  const response = await axiosInstance.get("/opportunities/saved/list");
  return response.data.data;
};

export const getRecentOpportunities = async () => {
  const response = await axiosInstance.get("/opportunities/recent");
  return response.data.data;
};

export const getPendingOpportunities = async () => {
  const response = await axiosInstance.get("/opportunities/pending");
  return response.data.data;
};

export const approveOpportunity = async (id) => {
  const response = await axiosInstance.patch(`/opportunities/${id}/approve`);
  return response.data.data;
};
...
export const updateOpportunity = async (id, payload) => {
  const response = await axiosInstance.patch(`/opportunities/${id}`, payload);
  return response.data.data;
};
