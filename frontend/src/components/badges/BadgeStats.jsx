function BadgeStats({
  ...
  const progress = nextBadge
    ? Math.min((activityScore / nextBadge.requiredScore) * 100, 100)
    : 100;
    ...
    >
      ...
      >
        <div>
          ...
          <h2 className="text-5xl font-bold">{activityScore}</h2>
        </div>

        <div>
          <p className="text-white/80">Badges Earned</p>

          <h2 className="text-5xl font-bold">{badgeCount}</h2>
        </div>
      </div>
        ...
        <div>
          ...
          >
            <div>
              ...
              <p className="text-white/80">{nextBadge.badgeName}</p>
            </div>
