...
import { emitDashboardUpdate } from "../../socket/socket.js";
...
export const getApplicantsForOpportunity = async (
  ...
  if (!opportunity || opportunity.organizationId !== organization.id) {
...
export const updateApplicationStatus = async (
  ...
  emitDashboardUpdate(updatedApplication.student.userId);
